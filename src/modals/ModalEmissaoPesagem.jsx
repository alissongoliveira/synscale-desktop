...
import ModalCriacaoPesagem from "./ModalCriacaoPesagem";
...
export default function ModalEmissaoPesagem({ visible, onClose }) {
  ...
  return (
    <>
        ...
        >
          ...
          <div className="mt-12 flex gap-4">
            ...
            <div className="w-1/2 border rounded divide-y text-sm">
              ...
              <button
                className="w-full flex items-center gap-2 px-4 py-3 hover:bg-slate-100"
      ...
      {/* Modal de Criação */}
      {mostrarCriacao && (
        <ModalCriacaoPesagem onClose={() => setMostrarCriacao(false)} />
      )}
    </>
  );
}
