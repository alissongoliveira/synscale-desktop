    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center font-mono">
      ...
      >
        ...
        <div className="bg-[#D9D9D9] text-center py-2 font-bold tracking-wider text-sm relative">
          ...
          <button
            onClick={onClose}
            className="absolute right-4 top-2 text-slate-800 hover:text-black"
          >
            <X size={18} />
          </button>
        </div>
        ...
        <div className="flex gap-4 mt-4">
          {/* Balança 01 */}
          <div className="bg-[#E1E1E1] flex-1 rounded p-3">
        ...
        <div className="mt-4 flex flex-col gap-2">
          {[1, 2].map((n) => (
            ...
            >
              ...
              <button className="bg-slate-800 text-white px-3 py-1 rounded text-sm hover:bg-slate-700">
                Complemento
              </button>
            </div>
          ))}
